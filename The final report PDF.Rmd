...
```
  ...
  I removed the name, ticket number, and cabin number during the data import process because the name and ticket number are not important for training the data, and only a few cabin numbers will not aid in training the modes
